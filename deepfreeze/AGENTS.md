...
- Keep Golden read-only and create Active from Golden; never destructively test real subvolumes.
...
- Run engine, Btrfs loop, GRUB generation, and initramfs tests only on safe targets.
